...
- `components/Spinner.tsx` — small spinning-ring loading indicator (Tailwind's `animate-spin` on a ring), used wherever a plain "Loading…" line isn't enough feedback.
