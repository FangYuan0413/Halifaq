...
- `components/Logo.tsx` — the HalifaQ wordmark: a ring-and-tail "Q" mark with a tiny dot slowly orbiting it, breathing glow animation. Used on the landing page, feed sidebar/mobile header, and auth form so the brand looks consistent everywhere.
