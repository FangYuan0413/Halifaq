...
- `app/post/[id]/page.tsx` — post detail page: full post, reply box (text plus up to 3 photos, with the same carousel/fullscreen/zoom viewer as posts), and the list of replies (comments), all pulled live from Supabase.
