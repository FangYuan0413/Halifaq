...
// "Halifa", and the "Q" picked out in the same cyan accent so the pun reads
// clearly. Everything breathes with a slow glow pulse. Used anywhere the
// brand name appears so it stays consistent.
export default function Logo({
  ...
  return (
    ...
    >
      ...
      <span className="bg-gradient-to-r from-white to-gray-400 bg-clip-text font-[family-name:var(--font-logo)] font-bold tracking-tight text-transparent">
        Halifa
